...
import co.es.service.impl.ElasticsearchCommander;
import co.es.service.impl.ElasticsearchQuery;
...
public class AppMain {  
    ...
    @Autowired
    ElasticsearchCommander elasticsearchCommander;
    @Autowired
...
//    }  
    ...
    * @date 2015年6月16日 上午10:14:21  
    ...
    public void insertNo() {  
       ...
       //         .getBean(ElasticsearchService.class);  
        ...
        elasticsearchCommander.insertOrUpdateTaskInfo(taskInfoList);  
    }  
    ...
    * @date 2015年6月16日 上午10:14:21  
    ...
    public void serchNo() {  
        ...
        //        .getBean("es");  
        List<Map<String, Object>> al = elasticsearchQuery.queryForObject("task_info",  
    ...
    public void serchById() {  
        ...
        //com.sf.daidongxi.web.service.ElasticsearchService service = (com.sf.daidongxi.web.service.ElasticsearchService) context  
        //        .getBean("es");  
        List<Map<String, Object>> al = elasticsearchQuery.queryObjectById("task_info",  
                new String[] { "taskId" }, "9", "taskArea", SortOrder.DESC,  
                0, 2);  
...
//        com.sf.daidongxi.web.service.ElasticsearchService service = (com.sf.daidongxi.web.service.ElasticsearchService) context  
//                .getBean("es");  
        List<Map<String, Object>> al = elasticsearchQuery.queryForObjectForElasticSerch("task_info", "taskContent", "高",19,20);  
