...
@Service
public class ElasticsearchQuery implements InitializingBean {  
  
    private static final Logger logger = Logger.getLogger(ElasticsearchQuery.class);  
  
    @Autowired  
    private Client client;  
  
    private String esIndexName = "gaochun";  
    ...
    public List<Map<String, Object>> queryObjectById(String type, String[] fields, String content,  
            String sortField, SortOrder order, int from, int size) {  
        SearchRequestBuilder reqBuilder = client.prepareSearch(esIndexName)  
                .setTypes(type).setSearchType(SearchType.DEFAULT)  
                .setExplain(true);  
